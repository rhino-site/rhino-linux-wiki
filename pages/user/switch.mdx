...
<Callout type="warning" emoji="⚠">
  **Warning:** We are still looking for UBXI maintainers, and at this time currently no proper UBXI ports exist. This being said, the proper way to switch to any generic desktop environment available in normal repositories (GNOME, KDE, etc) is:
  ```bash
  # switch to UBXI
